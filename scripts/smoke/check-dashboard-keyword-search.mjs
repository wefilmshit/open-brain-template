...
if (!dashboardUrl) {
  console.error("Missing OPEN_BRAIN_URL. Example: OPEN_BRAIN_URL=https://your-dashboard.example.com OPEN_BRAIN_TOKEN=... node scripts/smoke/check-dashboard-keyword-search.mjs");
  process.exit(2);
}
